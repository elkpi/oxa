...
func TestCanonicalJSONValidatesAgainstSchema(t *testing.T) {
	...
	docs := map[string][]byte{
		...
		"thinkingResponse": mustResponseDoc(t, &Response{
			ID:    "resp_think",
			Model: "m",
			Content: []Block{
				ThinkingBlock{Thinking: "reasoning text", Signature: "sig_123"},
			...
			Usage: Usage{
				InputTokens:              10,
				OutputTokens:             20,
				CacheReadInputTokens:     ptr(int64(5)),
				CacheCreationInputTokens: ptr(int64(2)),
				InputTokensDetails:       &InputTokensDetails{CachedTokens: ptr(int64(5))},
				OutputTokensDetails:      &OutputTokensDetails{ReasoningTokens: ptr(int64(15))},
			},
		}),
		...
		"thinkingEventStream": mustEventStreamDoc(t, &EventStream{Events: []Event{
			MessageStart{ID: "m1", Model: "m"},
			ContentBlockStart{Index: 0, Block: ThinkingBlock{Thinking: ""}},
			ContentBlockDelta{Index: 0, Delta: ThinkingDelta{Text: "think"}},
			ContentBlockDelta{Index: 0, Delta: SignatureDelta{Signature: "sig"}},
			ContentBlockStop{Index: 0},
			MessageDelta{StopReason: StopEndTurn, Usage: Usage{InputTokens: 1, OutputTokens: 1}},
			MessageDone{},
		}}),
